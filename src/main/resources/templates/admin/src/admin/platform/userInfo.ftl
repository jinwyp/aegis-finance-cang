...
<#include "../common/leftmenu.ftl" >
    ...
    <section>
        ...
        <div class="content-wrapper ms-controller" ms-controller="userAddController">
            ...
            <h3 ms-visible="@pageShowStatus === 'info'">基本信息
                    ...
                    <form method="get" action="/" class="form-horizontal">
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="account" class="form-control m-b" ms-duplex="@currentUser.role" ms-visible="@pageShowStatus === 'add'" ms-duplex="@currentUser.role">
                        ...
                        <fieldset ms-visible="@currentUser.role ==='tradersAccountant'">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="account" class="form-control m-b" ms-visible="@pageShowStatus === 'add'" ms-duplex="@currentUser.belongToUser">
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input id="input-id-1" type="text" class="form-control" placeholder="请输入公司名称" ms-visible="@pageShowStatus === 'add'" ms-duplex="@currentUser.companyName">
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <span class="help-block m-b-none" ms-visible="@pageShowStatus === 'add'"><span class="text-danger">*&nbsp;为用户发送与找回密码的有效途径</span></span>
                        ...
                        <div class="btn-edit text-center" ms-visible="@pageShowStatus === 'add'">
                            <button class="btn btn-default btn-lg btn-primary" type="button" ms-click="@addUser()">保存</button>
